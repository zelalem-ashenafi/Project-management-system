...
<link rel="icon" type="image/x-icon" href="../assets/dbu.png">
  ...
  <title>Advisor Sign UP | RPMS</title>
  ...
  <body>
    ...
    <form onSubmit="return validateform()"  action="" method="post">
     	...
     	<?php } ?>
          ...
          <?php if (isset($_GET['adv_id'])) { ?>
               <input type="text" required  
                      name="adv_id" 
                      placeholder="id"
                      value="<?php echo $_GET['adv_id']; ?>"><br>
          <?php }else{ ?>
               <input type="text" required  
                      name="adv_id" 
                      placeholder="Advisor ID"><br>
          <?php }?>
...
if(isset($_POST["signup"]))
{
    ...
    $sql="insert into advisors (adv_id,adv_name,dept,password,adv_phone) values ('$id','$name','$dept','$hashPassword','$phone')";
$conn->query($sql);
