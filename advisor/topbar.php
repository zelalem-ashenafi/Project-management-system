...
<nav class="navbar navbar-expand" style="background: #5193D1;">
	...
	$query = "SELECT COUNT(*) newm FROM annoncements where isread= 0 and (receiver='$adv_name' or receiver='$adv_id')";
	...
	<div class="topber__profile">
						...
						<div class="dropdown">
							<button class="btn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								...
								$adv_name = $_SESSION['login_adv_name'];
								echo $adv_name;
								$stud_id = $_SESSION['login_adv_id'];
								$query = "SELECT COUNT(*) newm FROM annoncements where isread= 0 and receiver='$adv_name'";
