...
<tr>
    ...
    $login_stud_id=$_SESSION['login_stud_id'];
    include 'db_connect.php';
    $sql = "SELECT * FROM students where stud_id='$login_stud_id'";
...
<td> Your ID : </td><td><input type="text" required  name="stud_id" value="<?php echo $stud_id?>"></td>
</tr>
<tr>
<td> Your Name : </td><td><input type="text" required  name="stud_name" value="<?php echo $stud_name?>"></td>
</tr>
<tr>
...
$sql="UPDATE students SET stud_id = '$stud_id', stud_name = '$stud_name', dept = '$dept', password = '$password' WHERE stud_id = '$login_stud_id';";
