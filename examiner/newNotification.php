...
$adv_name=$_SESSION['login_ev_id'];
$adv_id=$_SESSION['login_ev_id'];
$sql = "SELECT annonce_id, sender,receiver,st_date, announce_text, isread from annoncements  where (receiver='$adv_name' or receiver='$adv_id') and isread=0 order by st_date desc";
