	...
	<div class="topber__profile ml-auto">
			...
			<div class="dropdown">
				...
				<?php
					...
					echo $_SESSION['login_department_head'];
					$stud_id=$_SESSION['login_department_ID'];
					$dept=$_SESSION['login_Department'];
					$query = "SELECT COUNT(*) newm FROM annoncements where isread= 0 and receiver='department';";
